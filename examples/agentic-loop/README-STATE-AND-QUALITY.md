# Agentic Loops - State Persistence & Quality Gates
This guide covers state persistence, quality gates, and long-running execution features that enable truly long-running (hours/days) autonomous workflows.
...
For complex workflows with multiple interdependent loops, see:

**[README-ORCHESTRATION.md](README-ORCHESTRATION.md)** - Complete guide to multi-loop features including:

- Dependency management and execution ordering
- Variable passing between loops
- Creator/checker patterns with automatic retries
- Cycle detection and error handling

Example creator/checker workflow:
